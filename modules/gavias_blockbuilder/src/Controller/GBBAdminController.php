...
class GBBAdminController extends ControllerBase {
  ...
  public function gavias_blockbuilder_list(){
    ...
    foreach ($results as $row) {
      ...
      $tmp[] = t('<a href="@link">Edit</a> | <a href="@link_2">Config</a> |  <a href="@link_3">Delete</a> | <a href="@link_4">Clone</a>', array(
  ...
  public function gavias_blockbuilder_edit($bid) {
    ...
    if(GAVIAS_EDITOR_VERSION == 1){
      $page['#attached']['library'][] = 'gavias_blockbuilder/gavias_blockbuilder.assets.admin_editor';
    }else{
