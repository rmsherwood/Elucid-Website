...
class ShortcodePluginManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/Shortcode', $namespaces, $module_handler, 'Drupal\gavias_blockbuilder\Plugin\ShortcodeInterface', 'Drupal\gavias_blockbuilder\Annotation\Shortcode');
