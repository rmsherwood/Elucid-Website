<div class="gbb-row-wrapper">
  ...
  <div class="<?php print $row_class ?>" <?php if(isset($row_attr['row_id']) && $row_attr['row_id']) print 'id="'.$row_attr['row_id'].'"' ?> style="<?php print $row_style ?>" <?php if($data_bg_video) print $data_bg_video; ?>>
  		  ...
  		  //Responsive
              ...
              ?>
                <div <?php if($column_id) print 'id="'.$column_id.'"' ?> class="gsc-column <?php print $class; ?>">
                  <div class="column-inner <?php print $class_col_parallax ?> <?php print $col_bg_size ?>" <?php echo(($col_style) ? 'style="'.$col_style.'"' : '');  ?>>
                    ...
                    <?php if(isset($col_attr['bg_attachment']) && $col_attr['bg_attachment']=='fixed'){ ?>
                      <div style="background-repeat: <?php print $col_attr['bg_repeat']; ?>;background-position:<?php print $col_attr['bg_position'] ?>;" class="<?php print $col_bg_size ?> gva-parallax-inner skrollable skrollable-between" data-bottom-top="top: -50%;" data-top-bottom="top: 0%;"></div>
                    <?php } ?>
                  </div>
                </div>
              <?php      
    ...
    <?php if(isset($row_attr['bg_attachment']) && $row_attr['bg_attachment']=='fixed'){ ?>
      <div style="background-repeat: <?php print $row_attr['bg_repeat']; ?>;background-position:<?php print $row_attr['bg_position'] ?>;" class="gva-parallax-inner skrollable skrollable-between <?php print $row_bg_size ?>" data-bottom-top="top: -50%;" data-top-bottom="top: 0%;"></div>
    <?php } ?>
  </div>  
</div>  